...
#### [答案] git add test.html  git commit -m "test" git push -u origin master -f

## [命令题] 回退到上一版本，并且提交到远端；
#### [答案] 先是git reflog 然后是 git reset --hard commit.id (上一个版本的id)
...
#### [答案]mvn archetype:create -DgroupId=cn.everlook.myweb -DartifactId=myweb -DpackageName=cn.everlook.myw
*
...
#### [答案]    maven package   maven install
*
...
#### [答案]names.stream().forEach(e->System.out.println("姓氏"+e));  names.stream().forEach(e->System.out.println(e));
...
#### [答案]new Thread(() -> System.out.println("线程1--test"));

## [编码题] 输出1995-06-01 01:12:24 -- 2014-07-10 02:12:15的时间差
#### [答案]
        //时间之间的差
        ```
        String startTime ="1995-06-01 01:12:24";
        String endtime = "2014-07-10 02:12:15";
