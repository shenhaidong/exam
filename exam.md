...
#### [答案] git add filename,get commit -m "注释",git push origin branch1

## [命令题] 回退到上一版本，并且提交到远端；
#### [答案] git reset --hard commit_id, git push -f
...
#### [答案]
Collections.sort(name, (String name1, String name2) -> {return name1.compareTo(name2);});
...
#### [答案] () -> System.out::println("线程1--test")

## [编码题] 输出1995-06-01 01:12:24 -- 2014-07-10 02:12:15的时间差
#### [答案]
        LocalDateTime ldt1 = LocalDateTime
                .of(LocalDate.of(1995, 6, 1), LocalTime.of(1, 12, 24));
        LocalDateTime ldt2 = LocalDateTime
                .of(LocalDate.of(2014, 7, 10), LocalTime.of(2, 12, 15));
...
#### [答案] $ npm install jquery --save/-S <pkg>
* 
...
#### [答案] $ npm install gulp --save-dev/-D <pkg>
* 
