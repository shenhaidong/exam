...
#### [答案] git checkout origin/Localbr

## [问答题] 如果生产端中接口报错，怎么用postman来调试接口；
#### [答案] 在postman中有Http请求方式 可以通过postman快速的随意组装出我们希望的request 录入URL 点击params可直接调试参数 点击Send发送后
...
## [填空题] Maven是一个项目管理和整合_的工具。可以让开发者的工作变得更简单。
#### [标签]
* 
...
## [填空题] 在前端中使用npm安装package,我们可以在package.json的dependencies里面添加的package有lodash moment redux____,至少列举三种。
...
#### [答案] gitbook serve gitbook help  gitbook build
...
#### [答案] npm install gulp -g   npm install gulp
...
#### [答案] api core legacy multipart length  digest  qs
