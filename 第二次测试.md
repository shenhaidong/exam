...
#### [答案] git checkout localbr

## [问答题] 如果生产端中接口报错，怎么用postman来调试接口；
#### [答案] 复制接口的URL到postman的request editor的指定位置，点击接口，即可在sidebar中查看接口的报错信息

## [问答题] Eslint中，怎么初始化一个项目；
#### [答案] eslint --init 会生成一个.json配置文件
...
#### [答案] gitbook help、gitbook serve、gitbook build
...
#### [答案] npm install -g gulp、 npm install --save-dev gulp
...
#### [答案] gulp-load-plugins、gulp-task-listing、yargs、gulp-util、del
